    ...
    <div className="container md:mt-12 mt-6">
      <div className="post-body">
        ...
        <p>
          ...
          <a href="mailto:contact@rojgarseeker.com">contact@rojgarseeker.com</a>
        </p>
        <h2>Disclaimers for Rojgar Seeker</h2>
        <p>
          All the information on this website –{" "}
          <a href="https://rojgarseeker.com/" target="_blank">
            https://rojgarseeker.com/
          </a>{" "}
          – is published in good faith and for general information purpose only.
          Rojgarseeker does not make any warranties about the completeness,
          reliability, and accuracy of this information. Any action you take
          upon the information you find on this website (Rojgarseeker), is
          strictly at your own risk. Rojgarseeker will not be liable for any
